...
describe('Form Sizing Medium', () => {
  ...
  it(`should set flex to "${flex}" for nuSizeMedium and ignSizeMedium set to true`, () => {
    component.sizeMedium = true;
  ...
  it(`should set flex to "${flex}" for nuSizeMedium and ignSizeMedium set to null`, () => {
  ...
  describe('NgOnChanges', () => {
    ...
    it(`should set flex to "${flex}" once triggered`, () => {
