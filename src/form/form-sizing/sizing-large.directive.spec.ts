...
@Component({
    template: `
        ...
        <h1 class="directive" ignSizeLarge="true">largeTrue</h1>
        <h3 class="directive" nuSizeLarge="true">largeTrue</h3>        
        <textarea class="directive" ignSizeLarge="false">largeFalse</textarea>
        <p class="directive" nuSizeLarge="false">largeFalse</p>
    `
})
...
describe('SizingLargeDirective', () => {
    ...
    describe('NgOnChanges', () => {
        ...
        beforeEach(() => {
            neIgnLarge = de[0].nativeElement;
            neNuLarge = de[1].nativeElement;
            directive = de[0].injector.get(SizingLargeDirective);
